...
angular.module("codeEnjoy")
  .controller("introduceCoursesCtrl", function($scope, $location){
    ...
    $scope.professorName = "문성훈";
    $scope.professorImg ='images/professorImages/문성훈.jpg';
    $scope.subjectName = $scope.courseInfo.courseName;
    $scope.recentImage = 'images/coursesImage/'+$scope.subjectName+'.png'

    $scope.otherProfessors = [
      {
    ...
    $scope.otherProfessorInfo = function(CourseId, ProfessorId){
